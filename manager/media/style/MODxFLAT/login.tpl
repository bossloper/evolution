...
<head>
    <title>[+site_name+] (CMF Manager Login)</title>
    ...
    body {font-size: 75%; /* 12px 62.5% for 10px*/margin-bottom: 1px; /* avoid jumping scrollbars */
		/* uxello */
...
border-bottom: 3px solid #499bea;
   ...
   .sectionHeader a,.sectionHeader a:active,.sectionHeader a:visited,.sectionHeader a:link {color: #499bea;text-decoration: none;}
    ...
    #mx_loginbox {width: 460px;margin: 15px auto 0; border: 1px solid #ddd;
