                ...
                // QM+ with toolbar
                    ...
                    if(isset($_SESSION['mgrValidated']) && $_REQUEST['z'] != 'manprev') {
                            ...
                            foreach($buttons as $key => $field) {
                                ...
                                if ($showButton) {
                                    switch ($buttonAction)
                                    {
                                        ...
                                        case 'link': // uxello target blank
                                            $customButton  = '
                                            <li class="qm-custom-'.$i.' qmCustom">
                                            <a class="qmButton qmCustom" href="'.$buttonParentId.'" target="_blank" ><span>'.$buttonTitle.'</span></a>
                                            </li>
                                            ';    
                                        break;
                        ...
                        if ($this->managerbutton == 'true') {
                            $managerButton  = '
                            <li class="qmManager">
                            <a class="qmButton qmManager" title="'.$_lang['manager'].'" href="'.$this->modx->config['site_manager_url'].'" ><span>'.$_lang['manager'].' &raquo;</span></a>
                            </li>
                            ';
...
// NEW Binding by Uxello (revised feb 2012)
